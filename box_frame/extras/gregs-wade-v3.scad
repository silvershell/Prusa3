...
module wadeidler()
{
	...
	difference()
	{
		...
		translate(idler_axis+[2-idler_height,0,0])
		{
			...
			rotate([0,90,0])
			{
				...
				if( wade_idler_mounting_spring_hole_diameter ){
						cylinder(d=wade_idler_mounting_spring_hole_diameter,h=idler_height/2,$fn=16);
						translate([0,idler_mounting_hole_elongation,0])
						cylinder(d=wade_idler_mounting_spring_hole_diameter,h=idler_height/2,$fn=16);
						translate([-wade_idler_mounting_spring_hole_diameter/2,0,0])
						cube([wade_idler_mounting_spring_hole_diameter,idler_mounting_hole_elongation,
								idler_height/2]);
				}
			}
	...
	if( wade_idler_mounting_spring_hole_diameter )
	{
				wade_idler_mounting_spring_h = 0;
		for(idler_screw_hole=[-1,1])
		translate(idler_axis+[2-idler_height,0,0])
		{
			//Spring Holes Support
			translate([-1 + idler_height/2,idler_mounting_hole_up,
				idler_screw_hole*idler_mounting_hole_across])
			rotate([0,90,0])
			{
				cylinder(d=wade_idler_mounting_spring_hole_diameter,h=layer_height,$fn=16);
				translate([0,idler_mounting_hole_elongation,0])
				cylinder(d=wade_idler_mounting_spring_hole_diameter,h=layer_height,$fn=16);
				translate([-wade_idler_mounting_spring_hole_diameter/2,0,0])
				cube([wade_idler_mounting_spring_hole_diameter,idler_mounting_hole_elongation,
